...
const Profile = ({ type, name, avatar, email, properties }: ProfileProps) => (
  <Box>
    ...
    >
      ...
      >
        <img
          src="https://raw.githubusercontent.com/JamesCDrysdale/RealEstateDashboard/main/src/assets/rio-rainforest-city.jpg"
          width={340}
          height={320}
          alt="abstract"
              ...
              <Stack direction="column" gap="30px">
                <Stack gap="15px">
                  ...
                  <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                    ...
                    <Typography fontSize={14} color="#11142D">Edinburgh, UK</Typography>
                  </Box>
                </Stack>
                ...
                <Stack direction="row" flexWrap="wrap" gap="20px" pb={4}>
                  <Stack flex={1} gap="15px">
                    ...
                    <Box display="flex" flexDirection="row" alignItems="center" gap="10px">
                      ...
                      <Typography fontSize={14} color="#11142D" noWrap>+44 7492 371 238</Typography>
                    </Box>
                  </Stack>
